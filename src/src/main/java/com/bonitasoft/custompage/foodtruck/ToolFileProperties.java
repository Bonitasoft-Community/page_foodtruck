...
public class ToolFileProperties extends java.util.Properties
{
    ...
    private final static BEvent WriteFileError = new BEvent(ToolFileProperties.class.getName(), 1, Level.APPLICATIONERROR, "WriteError",
            "The properties file can not be write.",
            "Check the error");
    ...
    public static FoodTruckResult writePropertiesFile(final PropertiesParam propertiesParam, final String ldapSynchronizerPath,
            final String domain)
    {
