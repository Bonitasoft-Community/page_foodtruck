...
public class Toolbox {
    ...
    /**
     * This class :
     * - get the apps available on BonitaTStore
     * - get the local Apps install
     * - give a status apps per apps
     * if foodTruckParam.listcustompage is true, then the custom page is checked
     * if foodTruckParam.callAppStoreCustomPages is true, the AppsStore is call to search new apps, new update
     *
    ...
    public static class FoodTruckResult
    {
        ...
        /**
         * on some operation for one custom page, like a Download, this status is updated
         */
